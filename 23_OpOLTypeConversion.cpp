...
int main()
{
	...
	/* C++ style casts are checked by the compiler. C style casts aren't and can 
	   fail at runtime. */
	   
	/* typeid operator: returns type identification information at run time.
	   It basically returns a type_info object */
